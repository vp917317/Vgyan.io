...
function Notes() {
  ...
  const sendMessage = (message) => {
    const url = process.env.API_ENDPOINT_NOTES;//"https://bot1-394316.et.r.appspot.com/notes";
    console.log(message);
                ...
                {hasChatStarted ? (
                  ...
                  >
                    ...
                    <p className="text-gray-400 mb-4">
                      General Science Notes AI, your intelligent note-taking assistant.
                    </p>
                  ...
                  {!hasChatStarted && (
                    <>
                      ...
                      <div className="p4 flex flex-row">
                        <button
                          onClick={() =>
                            handleExampleMessage("Article 82 of Indian Constitution")
                          }
                        ...
                        >
                         Constitution's Article 82  ➤
                        </button>
                        <button
                          onClick={() => handleExampleMessage("Major Rivers in India")}
                          className="text-grey-500 block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-300 mb-4"
                          style={{ border: "1px solid", margin: "5px" }}
                        >
